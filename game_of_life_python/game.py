...
def _valida_nasce(linha, coluna, tabuleiro, tabuleiro_aux):
...
def verifica_se_nasce(linha, coluna, tabuleiro, tabuleiro_aux):
    if linha - 1 < 0:
        tabuleiro_aux = _valida_nasce(linha+1, coluna, tabuleiro, tabuleiro_aux)
        if coluna + 1 < 4:
            tabuleiro_aux = _valida_nasce(linha, coluna+1, tabuleiro, tabuleiro_aux)
            tabuleiro_aux = _valida_nasce(linha+1, coluna+1, tabuleiro, tabuleiro_aux)
        if coluna - 1 >= 0:
            tabuleiro_aux = _valida_nasce(linha, coluna-1, tabuleiro, tabuleiro_aux)
            tabuleiro_aux = _valida_nasce(linha+1, coluna-1, tabuleiro, tabuleiro_aux)
    elif linha + 1 > 4:
